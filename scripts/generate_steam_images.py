...
backside_path = "/Users/conniesun/Documents/pokemon_game/backside/edited"
pokemon_path = "/Users/conniesun/Documents/pokemon_game/output"

# Define the output path of the this
final_path = "/Users/conniesun/Documents/pokemon_game/final"
...
for index, row in pokemon_db.iterrows():
    ...
    pokemon_files = [f for f in os.listdir(pokemon_path) if re.match(pattern, f.lower())]
