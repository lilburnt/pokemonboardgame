...
image_folder_path = '/Users/conniesun/Documents/pokemon_game/output/'
...
def create_print_page(page_number, image_files, images_per_page):
    ...
    output_path = os.path.join('/Users/conniesun/Documents/pokemon_game/print/', f'print_page_{page_number + 1}.png')
